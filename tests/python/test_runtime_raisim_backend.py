...
def test_runtime_raisim_backend() :
    ...
    runtime = loco.sim.Runtime( loco.sim.PHYSICS_RAISIM, loco.sim.RENDERING_NONE )
    ...
    simulation.Pause()
    simulation.Resume()
    assert ( simulation.backendId == 'RAISIM' )
...
if __name__ == '__main__' :
    _ = input( 'Press ENTER to start test : test_runtime_raisim_backend' )
    test_runtime_raisim_backend()
