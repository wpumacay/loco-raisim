...
TEST( TestLocoRuntimeRaisimBackend, TestRuntimeRaisimBackend )
{
    loco::TLogger::Init();
    ...
    auto runtime = std::make_unique<loco::TRuntime>( loco::config::physics::RAISIM,
    ...
    EXPECT_EQ( simulationRef->backendId(), "RAISIM" );
